...
英語・韓国語・中国語・フランス語の単語とフレーズをカテゴリ別に学べるシンプルな静的サイトです。

## できること

- 英語 / 韓国語 / 中国語 / フランス語の学習言語切り替え
- 初級 / 実用単語 / ビジネス / 旅行の4カテゴリ切り替え
- 日本語の意味を見て学習語を選ぶ四択クイズ
...
- 読み上げ機能はブラウザ依存です
- 英語の単語データは `vocabulary.js`、英語のフレーズデータは `phrases.js` を編集すれば増やせます
- 韓国語・中国語・フランス語のデータは `language-packs.js` を編集すれば増やせます
